...
class FeatureEngineer:
    ...
    def run(self):
        try:
            ...
            self.save_data()
            logger.info("Your FE Pipeline ran successfully")
            
        except Exception as e:
            logger.error(f"Error while Running of FE Pipeline: {e}")
            raise CustomException("Error while  Running of FE Pipeline", sys)
        finally:
